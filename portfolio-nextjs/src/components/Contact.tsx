            ...
            <div className="container" >
                <div className="contact-layout" >
                    ...
                    <div className="contact-right reveal reveal-delay-2">
                        <a href="mailto:usenvictor40@gmail.com?subject=Web&body=Hi, Victor I just came across your Portfolio, and I'd like to discuss an opportunity for you ..." className="contact-item">
